...
export default class Samples {
    ...
    static playHowTo (e) {
        ...
        // Use SPA Router para navegar ao Getting Started
        window.currentStartingPlace = 'help';
    ...
    static loadMe (e, mt) {
        ...
        var md5 = mt.md5;
        // Use SPA Router para navegar ao editor
        window.currentProjectMd5 = md5;
        window.currentEditorMode = (window.Settings.useStoryStarters) ? 'storyStarter' : 'look';
        window.ScratchJrRouter.navigateTo('editor');
    }
