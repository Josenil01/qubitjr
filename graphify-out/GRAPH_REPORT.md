...
## Corpus Check
- 78 files · ~113,100 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1942 nodes · 4347 edges · 89 communities (43 shown, 46 thin omitted)
...
Cohesion: 0.07
Nodes (20): CARET_TYPES, SPEED_LABELS, NUMERIC_ARG_TYPES, emptyManifest(), walkScript(), computeDetailedManifest(), registerGalleryRestrictionProvider(), TRIGGER_TYPES (+12 more)
