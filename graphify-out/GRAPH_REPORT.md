...
## Corpus Check
- 78 files · ~113,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1942 nodes · 4348 edges · 89 communities (43 shown, 46 thin omitted)
...
Cohesion: 0.07
Nodes (20): CARET_TYPES, SPEED_LABELS, NUMERIC_ARG_TYPES, emptyManifest(), walkScript(), computeDetailedManifest(), dismissedHintIds, authHeader() (+12 more)

## Knowledge Gaps
- **53 isolated node(s):** `loadassets`, `fontcolors`, `fontsizes`, `getshapes`, `sendshapes` (+48 more)
...
- **Why does `Paint` connect `Block Connection Logic` to `Editor Bootstrap & Block Drag Utilities`, `Paint Save & Navigation`, `Paint Color & Pen Tools`, `Paint Asset Loading`, `IO Persistence Layer`, `Scripts Pane & Stage UI`, `Paint Gesture Detection`, `Paint Side Palette`, `Page/Sprite Thumbnails`, `Paint Canvas Pan & Zoom`, `Paint Workspace Setup`?**
