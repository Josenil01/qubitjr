...
## Corpus Check
- 1 files · ~108,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1923 nodes · 4311 edges · 84 communities (43 shown, 41 thin omitted)
...
### Community 8 - "Block & Alert Drawing Utils"
Cohesion: 0.10
...
### Community 21 - "Player Mode Patches"
Cohesion: 0.10
...
### Community 24 - "ScratchJr App Core"
Cohesion: 0.15
...
### Community 35 - "In-App Help Guides"
Cohesion: 0.18
...
### Community 43 - "SVG Image Element"
Cohesion: 0.19
...
### Community 69 - "Color Conversion Helpers"
Cohesion: 0.25
...
- **Why does `gn()` connect `In-App Help Guides` to `Live Mirror Sync`, `Paint Action History`, `Execution Engine Core`, `Editor UI Core`, `iOS Platform Bridge`, `Block & Alert Drawing Utils`, `Stage Engine`, `Page/Sprite Thumbnails`, `Vector Path Editing`, `Ghost Outline Tool`, `Player Mode Patches`, `Home Lobby Events`, `ScratchJr App Core`, `Home Lobby Entry`, `Block Spec Catalog`, `Block Rendering`, `SVG Transform Matrix`, `Sound/Video Recording UI`, `Input Event Handling`, `Editor Entry Boot`, `Paint Layer Management`, `Undo/Redo Stack`, `Lobby-Viewport Wiring`, `Stage Grid Overlay`, `Path Background Cropping`, `Bezier Curve Drawing`, `SVG Image Element`, `Path Edit Mode`, `Paint Undo Buffer`, `Camera Capture`, `Sample Projects List`, `Mission Notification Bell`, `Path Point Manipulation`, `Path Intersection Detection`?**
  _High betweenness centrality (0.244) - this node is a cross-community bridge._
- **Why does `ScratchJr` connect `ScratchJr Core State` to `App Boot Sequence`, `Execution Engine Core`, `Block & Alert Drawing Utils`, `Stage Grid Overlay`, `Fullscreen Control`, `Selection State`, `Argument Editing State`, `Numeric Keypad Input`, `Player Mode Patches`, `ScratchJr App Core`, `Block Spec Catalog`, `Block Rendering`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `Paint` connect `Paint Editor Core` to `Paint Asset Import (XML)`, `Paint Gesture Detection`, `Paint Side Palette`, `Player Mode Patches`, `Paint Canvas Positioning`, `ScratchJr App Core`, `Paint Grid Overlay`, `Block Rendering`, `Paint Page Navigation`, `Paint Color/Size Picker`?**
