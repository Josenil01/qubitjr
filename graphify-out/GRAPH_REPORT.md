...
## Corpus Check
- 1 files · ~109,708 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1931 nodes · 4328 edges · 86 communities (42 shown, 44 thin omitted)
...
- [[_COMMUNITY_In-App Guides & Layout Helpers|In-App Guides & Layout Helpers]]
...
Cohesion: 0.07
Nodes (4): UI, buffer, newHTML(), newTextInput()
...
Cohesion: 0.09
Nodes (6): Block, CSSTransition(), newForm(), setCanvasSize(), setCanvasSizeScaledToWindowDocumentHeight(), setProps()

### Community 13 - "ScratchJr App Core"
Cohesion: 0.12
Nodes (24): onBackButtonCallback, workingCanvas, workingCanvas2, maskCanvas, maskData, offscreen, targetOffscreen, deltaPoint (+16 more)

### Community 14 - "Stage & Scripts UI Layer"
Cohesion: 0.12
Nodes (19): pinchcenter, css_vh(), css_vw(), drawScaled(), fitInRect(), getDocumentHeight(), getDocumentWidth(), getFit() (+11 more)

### Community 25 - "Block & Sprite Interaction Layer"
Cohesion: 0.13
Nodes (12): fontcolors, fontsizes, getshapes, loadassets, sendshapes, speeds, Menu, Alert (+4 more)
...
Cohesion: 0.14
Nodes (6): Lobby, ensureEditorFrames(), libInit(), preprocess(), preprocessAndLoad(), preprocessAndLoadCss()

### Community 34 - "Snap.svg Shim"
Cohesion: 0.09
Nodes (3): SnapElement, SnapPaper, SnapShim

### Community 36 - "Home Lobby Entry"
Cohesion: 0.16
Nodes (6): homeMain(), homeStrings(), keys, Cookie, Localization, localizationMessages

### Community 37 - "In-App Guides & Layout Helpers"
Cohesion: 0.15
Nodes (5): inappAbout(), inappBlocksGuide(), inappInterfaceGuide(), inappPaintEditorGuide(), gn()

### Community 38 - "Editor Entry Boot"
Cohesion: 0.15
...
### Community 42 - "Player Mode Patches"
Cohesion: 0.22
...
### Community 49 - "Mission Authoring Button"
Cohesion: 0.25
...
### Community 53 - "Player Mode Patches"
Cohesion: 0.18
Nodes (4): defaultSounds, projectSounds, uiSounds, Sound

### Community 72 - "Mission Notification Bell"
Cohesion: 0.52
...
- **Why does `gn()` connect `In-App Guides & Layout Helpers` to `Live Mirror Sync`, `Paint Action History`, `Execution Engine Core`, `Editor UI Core`, `iOS Platform Bridge`, `Block Connection Logic`, `Stage Engine`, `ScratchJr App Core`, `Stage & Scripts UI Layer`, `Scripts Pane Blocks`, `Page/Sprite Thumbnails`, `Vector Path Editing`, `Ghost Outline Tool`, `Home Lobby Events`, `Block & Sprite Interaction Layer`, `SVG Transform Matrix`, `Sound/Video Recording UI`, `Input Event Handling`, `Paint Layer Management`, `Undo/Redo Stack`, `In-App Help Guides`, `Home Lobby Entry`, `Editor Entry Boot`, `Path Background Cropping`, `Stage Grid Overlay`, `Block Spec Catalog`, `Path Edit Mode`, `Bezier Curve Drawing`, `SVG Image Element`, `Player Mode Patches`, `Paint Undo Buffer`, `Path Intersection Detection`, `Camera Capture`, `Sample Projects List`, `Mission Notification Bell`, `Path Point Manipulation`, `Editor Entry Boot`?**
  _High betweenness centrality (0.243) - this node is a cross-community bridge._
- **Why does `ScratchJr` connect `ScratchJr Core State` to `Execution Engine Core`, `App Boot Sequence`, `Editor UI Core`, `Stage Grid Overlay`, `Block Connection Logic`, `Player Mode Patches`, `Selection State`, `ScratchJr App Core`, `Argument Editing State`, `Fullscreen Control`, `Numeric Keypad Input`, `Stage & Scripts UI Layer`, `Block & Sprite Interaction Layer`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `Paint` connect `Paint Editor Core` to `Paint Page Navigation`, `Paint Side Palette`, `Paint Asset Import (XML)`, `Block Connection Logic`, `Player Mode Patches`, `ScratchJr App Core`, `Stage & Scripts UI Layer`, `Paint Gesture Detection`, `Paint Side Palette`, `Paint Canvas Positioning`, `Paint Grid Overlay`?**
