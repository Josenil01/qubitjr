...
Cohesion: 0.10
Nodes (4): Block, CSSTransition(), newForm(), setProps()

### Community 19 - "Scripts Pane & Stage UI"
Cohesion: 0.14
Nodes (13): deltaPoint, initialPoint, pensizes, pinchcenter, getDocumentHeight(), getDocumentWidth(), getIdFor(), hitRect() (+5 more)
...
Cohesion: 0.13
Nodes (13): fontcolors, fontsizes, getshapes, loadassets, sendshapes, speeds, onBackButtonCallback, workingCanvas (+5 more)
...
Cohesion: 0.14
Nodes (17): css_vh(), css_vw(), ensureEditorFrames(), fitInRect(), getFit(), getHex(), getRGB(), getViewportHeight() (+9 more)
...
Cohesion: 0.20
Nodes (6): Menu, Alert, drawThumbnail(), getStringSize(), globalx(), globaly()
...
- **Why does `ScratchJr` connect `ScratchJr App Core` to `Editor Bootstrap & Block Drag Utilities`, `App Boot Sequence`, `Path Edit Mode`, `Web Interface Bridge`, `IO Persistence Layer`, `Scroll/Pan Control`, `Selection State`, `Fullscreen Control`, `Numeric Keypad Input`, `Scripts Pane & Stage UI`, `Page/Sprite Thumbnails`, `ScratchJr Core State`?**
